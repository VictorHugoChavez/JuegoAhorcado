...
var listaPalabras = ["musica", "magia", "baile", "amor", "enamoramiento", "color", "arte",
    "artistico", "seduccion", "amigos", "camaron", "cultura", "amanecer", "pintura", "soleado",
    "caminos", "proyectos", "soñar", "cancion", "camarederia"
];
...
modo.addEventListener('click', function() {
    if (window.modoOscuro == false) {
        ...
        r.style.setProperty('--color1', '#000000');
        ...
        r.style.setProperty('--color2', '#c6b9cc');
        r.style.setProperty('--color3', '#8a94b6');
        r.style.setProperty('--color4', '#a3acd3');
        r.style.setProperty('--color5', '#02175c');
        window.modoOscuro = false
        this.src = "assets/img/moon.png"
        let intento_back = window.intento
        window.intento = 0
        for (let i = 0; i < intento_back; i++) {
            drawGame()
